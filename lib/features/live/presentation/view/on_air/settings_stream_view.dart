...
class SettingsStreamView extends ConsumerStatefulWidget {
  const SettingsStreamView({super.key});

  @override
  ConsumerState<SettingsStreamView> createState() =>
      _SettingsStreamViewScreenState();
}

class _SettingsStreamViewScreenState extends ConsumerState<SettingsStreamView> {
  ...
  void initState() {
    ...
    _previewUrlController = TextEditingController(text: formState.previewUrl);
  }
